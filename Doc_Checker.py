...
json_file = "some_doc.json"
#place number of the certificate in the json file
row_nb = 2
#name of the txt file
txt_file = "N584D Registration"


#N685DC Registration : row_nb = 0
#6303_FAA_CofR_N66ZG : row_nb = 1
#N584D Registration : row_nb = 2
...
def comparison(filename_txt,json_data,debug):
    ...
    if (debug):
        print(data_txt)
    date_txt = find_date(filename_txt+'.txt') #'DateOfRegistry'
    if debug:
